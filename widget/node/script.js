...
function setMode(mode) {
    ...
    document.querySelectorAll('.mode-btn').forEach(btn => btn.style.background = '#4CAF50');
    
    switch(mode) {
        case 'addNode':
            document.getElementById('addNodeBtn').style.background = '#45a049';
            document.getElementById('network').style.cursor = 'crosshair';
            break;
        case 'addEdge':
            document.getElementById('addEdgeBtn').style.background = '#45a049';
            document.getElementById('network').style.cursor = 'pointer';
            break;
        case 'edit':
            document.getElementById('editBtn').style.background = '#45a049';
